    ...
    */
    ...
    'connections' => [
        ...
        'pgsql' => [
            ...
            'host' => env('DB_HOST', 'coolify-db-v5'),
            'port' => env('DB_PORT', '5432'),
            'database' => env('DB_DATABASE', 'coolify_v5'),
            'username' => env('DB_USERNAME', 'coolify_v5'),
            'password' => env('DB_PASSWORD', 'coolify-v5'),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => 'public',
